class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 250, y: height - 1400, image: obstacle2Image },
      { x: width / 2 + 280, y: height - 2000, image: obstacle2Image },
      { x: width / 2 - 260, y: height - 3170, image: obstacle2Image },
     
      { x: width / 2 - 260, y: height - 3630, image: obstacle2Image },
      { x: width / 2, y: height - 5830, image: obstacle2Image },
    ];
